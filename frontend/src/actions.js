...
export const userlogin=(userId,paasword)=>{
    return{
        type:LOGIN,
        userId:userId,
        password:paasword
...
export const gotoprofile = (input)=>{
    return {
        type:GOTOPROFILE,
        input:input
    }
...
export const requestusergroup = (usergroup)=>{
    return {
        type:REQUESTUSERGROUP,
        usergroup:usergroup
    }
}

export const requestcomment = (comments)=>{
    return {
        type:REQUESTCOMMENT,
        comments:comments
    }
